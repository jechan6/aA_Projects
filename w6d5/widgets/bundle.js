  ...
  _createClass(Root, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_tabs2.default, { tabsList: tabList })
      );
    }
  }]);
...
var _tabsitem = __webpack_require__(/*! ./tabsitem */ "./frontend/tabsitem.jsx");
...
var Tabs = function (_React$Component) {
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'ul',
          null,
          this.props.tabsList.map(function (tab, idx) {
            return _react2.default.createElement(
              'div',
              null,
              _react2.default.createElement(
                'h1',
                { onClick: _this2.changeTab.bind(_this2, idx) },
                tab.title
              ),
              _react2.default.createElement(_tabsitem2.default, { key: idx, index: idx, content: tab.content })
            );
          }),
          ';'
        )
    ...
    value: function changeTab(idx) {
      var classn = "content-" + idx;
      var content = document.getElementsByClassName(classn);
      var hideContent = document.getElementsByTagName("li");
      // console.log(hideContent);
      Array.from(hideContent).map(function (el) {
